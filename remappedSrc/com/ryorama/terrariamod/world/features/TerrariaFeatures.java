...
public class TerrariaFeatures {
	...
	public static void init() {
		RegistryKey<ConfiguredFeature<?, ?>> copperOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
		...
		RegistryKey<ConfiguredFeature<?, ?>> copperOreSurface = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
		...
		RegistryKey<ConfiguredFeature<?, ?>> copperOreTwo = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
		...
		RegistryKey<ConfiguredFeature<?, ?>> copperOreSurfaceTwo = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
