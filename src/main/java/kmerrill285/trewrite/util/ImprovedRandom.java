...
public class ImprovedRandom {
    ...
    public static ImprovedRandom getThreadLocal4Pos(BlockPos pos) {
        return getThreadLocal(net.minecraft.util.math.MathHelper.getCoordinateRandom(pos.getX(), pos.getY(), pos.getZ()));
    }
