...
public class ModelVoodooDemon extends EntityModel<EntityVoodooDemon> {
	private final RendererModel bone2;
	private final RendererModel bone;
	private final RendererModel bb_main;

	public ModelVoodooDemon() {
		textureWidth = 64;
		textureHeight = 64;
	...
	@Override
	public void render(EntityVoodooDemon entity, float f, float f1, float f2, float f3, float f4, float f5) {
		bone2.render(f5);
		bone.render(f5);
		bb_main.render(f5);
	}
