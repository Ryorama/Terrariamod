...
public class RenderWormBody extends MobRenderer<MobEntity, ModelWormBody>
{
    private ResourceLocation wormTexture = new ResourceLocation("trewrite:textures/entity/worm/worm_body.png");

    public RenderWormBody(EntityRendererManager renderManagerIn)
    {
