...
public class EntityWyvernTail extends MobEntity implements IHostile {
	   public float velX;
	   public float velY;
	   public float velZ;
	   ...
	   public EntityWyvernTail(EntityType type, World worldIn) {
	      super(type, worldIn);
	   }

	   public EntityWyvernTail(World worldIn) {
	      super(EntitiesT.WYVERN_TAIL, worldIn);
	   }
	   ...
	   public static EntityWyvernTail spawnWormBody(World worldIn, BlockPos pos, float life, MobEntity owner) {
		   EntityWyvernTail head = (EntityWyvernTail)EntitiesT.WYVERN_TAIL.create(worldIn, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, pos, SpawnReason.EVENT, false, false);
