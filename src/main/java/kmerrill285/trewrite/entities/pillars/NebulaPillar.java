...
public class NebulaPillar extends MobEntity implements IHostile {
	...
	public NebulaPillar(EntityType<? extends NebulaPillar> type, World worldIn) {
		super(type, worldIn);
		isAlive = true;
		this.posY += 15;
	}
	
	public NebulaPillar(World worldIn) {
	...
	public void tick() {
		...
		if (WorldStateHolder.get(world).nebulaEnemiesDefeated >= 20) {
			canBeAttacked = false;
		}
	}
