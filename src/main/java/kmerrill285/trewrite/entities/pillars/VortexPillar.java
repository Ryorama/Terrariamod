...
public class VortexPillar extends MobEntity implements IHostile {
	...
	public VortexPillar(EntityType<? extends VortexPillar> type, World worldIn) {
		super(type, worldIn);
		isAlive = true;
		this.posY += 15;
	}
	
	public VortexPillar(World worldIn) {
	...
	public void tick() {
		...
		if (WorldStateHolder.get(world).vortexEnemiesDefeated >= 20) {
			canBeAttacked = false;
		}
	}
