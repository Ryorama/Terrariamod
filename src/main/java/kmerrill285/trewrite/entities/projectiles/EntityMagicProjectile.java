...
public class EntityMagicProjectile extends MobEntity {
   ...
   public EntityMagicProjectile(World worldIn, LivingEntity shooter, EntityType type) {
      super(type, worldIn);
   ...
   public EntityMagicProjectile(EntityType p_i50172_1_, World p_i50172_2_) {
   ...
   protected void onImpact(RayTraceResult result) {
      if (result.getType() == Type.ENTITY && this.weapon != null) {
         ...
         if (entity instanceof LivingEntity && entity != this.shooter && !(entity instanceof EntityMagicProjectile)) {
