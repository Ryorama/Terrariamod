...
public class EntityWormTail extends MobEntity implements IHostile {
   ...
   public EntityWormTail(EntityType type, World worldIn) {
      super(type, worldIn);
   }
   ...
   public static EntityWormTail spawnWormBody(World worldIn, BlockPos pos, float life, MobEntity owner) {
      EntityWormTail head = (EntityWormTail)EntitiesT.WORM_TAIL.create(worldIn, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, pos, SpawnReason.EVENT, false, false);
