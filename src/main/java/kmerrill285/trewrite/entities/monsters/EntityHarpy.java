...
public class EntityHarpy extends FlyingEntity {
	   public float rx;
	   public float ry;
	   public float rz;
	   ...
	   public EntityHarpy(EntityType type, World worldIn) {
	      super(type, worldIn);
	   }
	   ...
	   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
	      ...
	      this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(32);
	   ...
	   public void dropLoot(DamageSource source, boolean b) {
    	  ...
    	  EntityItemT.spawnItem(this.getEntityWorld(), this.getPosition(), new ItemStackT(ItemsT.HARPY_FEATHER, 1, (ItemModifier)null));
	   ...
	   static {
	      type_data = EntityDataManager.createKey(EntityHarpy.class, DataSerializers.VARINT);
	   }
	}
