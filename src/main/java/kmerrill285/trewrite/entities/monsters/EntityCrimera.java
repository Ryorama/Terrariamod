...
public class EntityCrimera extends FlyingEntity {
   ...
   public void init() {
      this.dataManager.set(type_data, this.rand.nextInt(6));
   }
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ...
      switch((Integer)this.dataManager.get(type_data)) {
      case 0:
      ...
      case 3:
         ...
         break;
      case 4:
         this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(66.0D);
         this.getAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(4.0D);
         this.damage = 14;
         this.kbResist = 0.28F;
         break;
   ...
   public void dropLoot(DamageSource source, boolean b) {
      ...
      if (rand.nextInt(5) == 0) {
    	  EntityItemT.spawnItem(this.getEntityWorld(), this.getPosition(), new ItemStackT(ItemsT.ROTTEN_CHUNK, 1, (ItemModifier)null));
      }
      
      if (rand.nextInt(7) == 0 && WorldStateHolder.get(world).hardmode == true) {
	      EntityItemT.spawnItem(this.getEntityWorld(), this.getPosition(), new ItemStackT(ItemsT.NIGHT_SOUL, 1, (ItemModifier)null));
      }
