...
public class EntityHallowSlime extends SlimeEntity {
	
	   public EntityHallowSlime(EntityType type, World worldIn) {
		      super(type, worldIn);
		      this.init();
		   }

		   public EntityHallowSlime(World world) {
		      super(EntitiesT.ICE_SLIME, world);
		      this.init();
		   }

		   public void init() {
		      this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(180);
		   ...
		   public void dropLoot(DamageSource source, boolean b) {
		      ...
		      {
			      EntityItemT.spawnItem(this.getEntityWorld(), this.getPosition(), new ItemStackT(ItemsT.LIGHT_SOUL, 1, (ItemModifier)null));
		      }
		   ...
		   public int getSlimeSize() {
			   return this.getHealth() > 0.0F ? 4 : 1;
		   }
