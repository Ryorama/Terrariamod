...
public class EntitySandSlime extends SlimeEntity {
   public EntitySandSlime(EntityType type, World worldIn) {
      super(type, worldIn);
      this.init();
   }

   public EntitySandSlime(World world) {
      super(EntitiesT.SAND_SLIME, world);
      this.init();
   }
