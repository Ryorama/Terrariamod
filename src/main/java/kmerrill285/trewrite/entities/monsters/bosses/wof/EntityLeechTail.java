...
public class EntityLeechTail extends MobEntity implements IHostile {
	...
	public EntityLeechTail(EntityType<? extends MobEntity> type, World worldIn) {
		super(type, worldIn);
	}
	
	public EntityLeechTail(World worldIn) {
		super(EntitiesT.LEECH_TAIL, worldIn);
	}
	...
	public void onCollideWithPlayer(PlayerEntity player) {
		player.attackEntityFrom(DamageSource.causeMobDamage(this), 18);
	}
...
//			
	...
	public static EntityLeechTail spawnWormBody(World worldIn, BlockPos pos, float life, MobEntity owner) {
		EntityLeechTail head = EntitiesT.LEECH_TAIL.create(worldIn, null, null, null, pos, SpawnReason.EVENT, false, false);
