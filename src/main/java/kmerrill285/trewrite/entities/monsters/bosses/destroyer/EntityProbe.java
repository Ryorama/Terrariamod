...
public class EntityProbe extends FlyingEntity {
	   public float rx;
	   public float ry;
	   public float rz;
	   ...
	   public EntityProbe(EntityType type, World worldIn) {
	      super(type, worldIn);
	      this.init();
	   }

	   public EntityProbe(World world) {
	      super(EntitiesT.PROBE, world);
	      this.init();
	   }
	   ...
	   protected void dealDamage(LivingEntity entityIn) {
	      if (this.isAlive() && this.canEntityBeSeen(entityIn) && entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), 0)) {
