...
public class EntityFaceMonster extends ZombieEntity implements IHostile {
	   public int money;

	   public EntityFaceMonster(EntityType type, World worldIn) {
	      super(type, worldIn);
	   }

	   public EntityFaceMonster(World worldIn) {
		   super(worldIn);
	   }
	   ...
	   protected void registerAttributes() {
	      ...
	      this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue((double)70);
	      this.getAttribute(SharedMonsterAttributes.ARMOR).setBaseValue((double)10);
	      this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((double)25);
