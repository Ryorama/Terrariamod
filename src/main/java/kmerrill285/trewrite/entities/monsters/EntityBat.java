...
public class EntityBat extends FlyingEntity {
   public float rx;
   public float ry;
   public float rz;
   ...
   public EntityBat(EntityType type, World worldIn) {
      super(type, worldIn);
      this.init();
   }

   public EntityBat(World world) {
      super(EntitiesT.BAT, world);
      this.init();
   }
   ...
   static {
      type_data = EntityDataManager.createKey(EntityBat.class, DataSerializers.VARINT);
   }
}
