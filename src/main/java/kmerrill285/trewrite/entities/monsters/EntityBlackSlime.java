...
public class EntityBlackSlime extends SlimeEntity {
   public EntityBlackSlime(EntityType type, World worldIn) {
      super(type, worldIn);
      this.init();
   }

   public EntityBlackSlime(World world) {
      super(EntitiesT.BLACK_SLIME, world);
      this.init();
   }
   ...
   public int getSlimeSize() {
	      return this.getHealth() > 0.0F ? 2 : 1;
   }
