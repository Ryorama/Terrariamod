...
public class EntityFlyingFish  extends FlyingEntity implements IHostile {
	...
	public float kbResist = 0.2f;
	 ...
	 public EntityFlyingFish(EntityType<EntityFlyingFish> type, World worldIn) {
		super(type, worldIn);
		init();
	}

    public EntityFlyingFish(World world) {
    	super(EntitiesT.FLYING_FISH, world);
    	init();
    }
    ...
    {
    	if (entityIn != null && (double)entityIn.getDistance(this) <= 1.5D) {
