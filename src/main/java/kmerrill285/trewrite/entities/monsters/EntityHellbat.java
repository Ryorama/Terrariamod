...
public class EntityHellbat extends FlyingEntity {
   public float rx;
   public float ry;
   public float rz;
   ...
   public EntityHellbat(EntityType type, World worldIn) {
      super(type, worldIn);
      this.init();
   }

   public EntityHellbat(World world) {
      super(EntitiesT.HELLBAT, world);
      this.init();
   }
   ...
   static {
      type_data = EntityDataManager.createKey(EntityHellbat.class, DataSerializers.VARINT);
   }
}
