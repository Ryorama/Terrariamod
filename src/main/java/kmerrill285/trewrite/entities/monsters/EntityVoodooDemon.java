...
public class EntityVoodooDemon extends FlyingEntity {
	   public float rx;
	   public float ry;
	   public float rz;
	   ...
	   public EntityVoodooDemon(EntityType type, World worldIn) {
	      super(type, worldIn);
	   }

	   public EntityVoodooDemon(World world) {
	      super(EntitiesT.VOODOO_DEMON, world);
	   }
	   ...
	   public void dropLoot(DamageSource source, boolean b) {
		  EntityItemT.spawnItem(this.getEntityWorld(), this.getPosition(), new ItemStackT(ItemsT.GUIDE_VOODOO_DOLL, 1, (ItemModifier)null));
	   ...
	   static {
	      type_data = EntityDataManager.createKey(EntityVoodooDemon.class, DataSerializers.VARINT);
	   }
	}
