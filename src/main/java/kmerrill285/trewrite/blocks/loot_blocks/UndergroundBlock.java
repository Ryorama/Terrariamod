...
public class UndergroundBlock extends BlockT {

	public UndergroundBlock(Properties properties, float hardness, float difficulty, String drop) {
	...
	public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
		...
		if (rand.nextInt(20) == 0) {
			EntityItemT.spawnItem(worldIn, pos, new ItemStackT(ItemsT.MAGIC_MIRROR, 1));
		}
		if (rand.nextInt(5) == 0) {
