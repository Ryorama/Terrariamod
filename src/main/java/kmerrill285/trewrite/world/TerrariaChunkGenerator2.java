...
public class TerrariaChunkGenerator2 extends NoiseChunkGenerator<OverworldGenSettings> {
	   ...
	   public TerrariaChunkGenerator2(IWorld worldIn, BiomeProvider provider, OverworldGenSettings settingsIn) {
