...
public class JungleHighlands extends Biome {
   protected JungleHighlands() {
      ...
      this.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(TerrariaFeatures.ORES, new TerrariaOreFeatureConfig(BlocksT.GRASS_BLOCK.getDefaultState(), BlocksT.MUD.getDefaultState(), 17), Placement.COUNT_RANGE, new CountRangeConfig(50, 0, 0, 128)));
      this.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(TerrariaFeatures.ORES, new TerrariaOreFeatureConfig(BlocksT.GRASS_BLOCK.getDefaultState(), BlocksT.DEEP_MUD.getDefaultState(), 17), Placement.COUNT_RANGE, new CountRangeConfig(25, 0, 0, 128)));
   }
