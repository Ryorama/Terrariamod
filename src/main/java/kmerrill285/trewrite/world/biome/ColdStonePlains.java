...
public class ColdStonePlains extends Biome {
   protected ColdStonePlains() {
      super((new Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(BlocksT.STONE_BLOCK.getDefaultState(), BlocksT.DIRT_BLOCK.getDefaultState(), BlocksT.STONE_BLOCK.getDefaultState()))).precipitation(RainType.SNOW).category(Category.EXTREME_HILLS).depth(0.3F).scale(0.05F).temperature(0.2F).downfall(1.0F).waterColor(4159204).waterFogColor(329011).parent((String)null));
