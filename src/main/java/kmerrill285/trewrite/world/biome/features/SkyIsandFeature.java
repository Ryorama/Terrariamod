...
public class SkyIsandFeature extends Feature<NoFeatureConfig> {	
	
	public SkyIsandFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
