...
public class ArcticShrubFeature extends Feature<NoFeatureConfig> {
	
		
	
	   public ArcticShrubFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
			 			...
			 			if (stuff[x][y][z] == Color.GREEN) {
			 				...
			 				if (worldIn.isAreaLoaded(pos2, 1)) {
			 					...
			 					if (worldIn.isAreaLoaded(pos2.up(), 1)) {
			 						worldIn.setBlockState(pos2.up(), Blocks.SNOW.getDefaultState(), 2);
			 					}
			 				}
