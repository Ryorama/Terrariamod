...
public class LivingwoodForest extends Biome {
   protected LivingwoodForest() {
      ...
      this.addFeature(Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(TerrariaFeatures.LIVINGWOOD_FOREST_TREE, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(48)));
   }
