...
public class DeepColdOcean extends Biome {
   public DeepColdOcean() {
      super((new Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(BlocksT.CLAY_BLOCK.getDefaultState(), BlocksT.STONE_BLOCK.getDefaultState(), BlocksT.STONE_BLOCK.getDefaultState()))).precipitation(RainType.RAIN).category(Category.DESERT).depth(-2.5F).scale(0.4F).temperature(0.5F).downfall(0.5F).waterColor(4020182).waterFogColor(329011).parent((String)null));
      ...
      this.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(TerrariaFeatures.ORES, new TerrariaOreFeatureConfig(BlocksT.CLAY_BLOCK.getDefaultState(), BlocksT.SAND.getDefaultState(), 45), Placement.COUNT_RANGE, new CountRangeConfig(20, 0, 0, 128)));
   }
