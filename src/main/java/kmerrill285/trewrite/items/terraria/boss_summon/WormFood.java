...
public class WormFood extends ItemT {
   public WormFood(Properties properties, String name) {
   ...
   public ActionResult onItemRightClick(World worldIn, PlayerEntity player, Hand handIn) {
      ...
      if (eocs.size() > 0) {
         ...
         if (inv.hotbar[inv.hotbarSelected].stack != null && inv.hotbar[inv.hotbarSelected].stack.item == this) {
            ...
            EntityEowHead eye = (EntityEowHead)EntitiesT.EOW_HEAD.create(worldIn, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, player.getPosition(), SpawnReason.EVENT, false, false);
