...
public class AbandonHouse {
    ...
    public static void generateStructure(World world, BlockPos pos) {
        ...
        PlaneGen.generatePlane(world, new BlockPos(pos.getX(), pos.getY() + 6, pos.getZ()), BlocksT.WOOD, 5,  1, 5);
        PlaneGen.generatePlane(world, new BlockPos(pos.getX(), pos.getY() + 7, pos.getZ()), BlocksT.WOOD, 5, 7, 0);
        PlaneGen.generatePlane(world, new BlockPos(pos.getX(), pos.getY() + 7, pos.getZ()), BlocksT.WOOD, 1, 7, 5);
        PlaneGen.generatePlane(world, new BlockPos(pos.getX(), pos.getY() + 7, pos.getZ() - 5), BlocksT.WOOD, 5, 7, 0);
        PlaneGen.generatePlane(world, new BlockPos(pos.getX() - 5, pos.getY() + 7, pos.getZ()), BlocksT.WOOD, 0, 7, 5);
        ...
        world.setBlockState(new BlockPos(pos.getX() + 2, pos.getY() + 7, pos.getZ()), Blocks.OAK_DOOR.getDefaultState(), 0);

        MiscGen.scatterBlocks(world, new BlockPos(pos.getX(), pos.getY() + 14, pos.getZ()), Blocks.AIR, 5, 5, 3);
        MiscGen.generateChestWithLoot(world, new BlockPos(pos.getX() + 2, pos.getY() + 8, pos.getZ() + 2), BlocksT.GOLD_CHEST, "underground_house");
    }
}
