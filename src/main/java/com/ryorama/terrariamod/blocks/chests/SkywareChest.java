...
import com.ryorama.terrariamod.entity.block.SkywareChestBlockEntity;
...
public class SkywareChest extends ChestT {
    ...
    public SkywareChest(Settings settings, Supplier<BlockEntityType<? extends ChestBlockEntity>> supplier) {
        super(settings, supplier);
    }

    @Override
    public Identifier getTexture() {
        return new Identifier(TerrariaMod.MODID, "block/chests/skyware_chest");
    }
