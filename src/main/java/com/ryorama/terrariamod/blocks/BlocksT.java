...
public class BlocksT {
	...
	public static BlockT GRASS_BLOCK = new BlockT(FabricBlockSettings.of(Material.SOIL), 15, 10).setPick(true);
	public static BlockT CORRUPTED_GRASS_BLOCK = new BlockT(FabricBlockSettings.of(Material.SOIL), 15, 10).setPick(true);
	public static BlockT JUNGLE_GRASS = new BlockT(FabricBlockSettings.of(Material.SOIL), 15, 10).setPick(true);
	public static BlockT MUD = new BlockT(FabricBlockSettings.of(Material.SOIL), 15, 10).setPick(true);
	public static BlockT SAND = new BlockT(FabricBlockSettings.of(Material.SOIL), 15, 10).setPick(true);
	public static BlockT SNOW = new BlockT(FabricBlockSettings.of(Material.SOIL), 15, 10).setPick(true);
	public static BlockT DIRT_BLOCK = new BlockT(FabricBlockSettings.of(Material.SOIL), 15, 10).setPick(true);
	public static BlockT STONE_BLOCK = new BlockT(FabricBlockSettings.of(Material.STONE), 15, 15).setPick(true);
	public static BlockT EBONSTONE = new BlockT(FabricBlockSettings.of(Material.STONE), 15, 65).setPick(true);
	public static BlockT ASH = new BlockT(FabricBlockSettings.of(Material.STONE), 15, 10).setPick(true);
	public static BlockT MARBLE = new BlockT(FabricBlockSettings.of(Material.STONE), 15, 15).setPick(true);
	public static BlockT GRANITE = new BlockT(FabricBlockSettings.of(Material.STONE), 15, 15).setPick(true);
	public static BlockT MUSHROOM_GRASS = new BlockT(FabricBlockSettings.of(Material.SOIL).luminance(15), 15, 10).setPick(true);
	public static BlockT WOOD = new BlockT(FabricBlockSettings.of(Material.STONE), 15, 10).setPick(true);
	public static BlockT WOODEN_BEAM = new BlockT(FabricBlockSettings.of(Material.STONE), 15, 10).setPick(true);
	...
	public static PlantT VINE = (PlantT) new PlantT(FabricBlockSettings.of(Material.STONE), 15, 1).setPick(true).setAxe(true);
	...
	public static LightBlockT HELLSTONE_ORE = (LightBlockT) new LightBlockT(FabricBlockSettings.of(Material.STONE), 15, 65, 10).setPick(true);
	...
	public static TreeSegment FOREST_STUMP = (TreeSegment) new TreeSegment(FabricBlockSettings.of(Material.WOOD), 15, 10).setAxe(true);
	public static TreeSegment FOREST_STEM = (TreeSegment) new TreeSegment(FabricBlockSettings.of(Material.WOOD), 15, 10).setAxe(true);
	public static TreeSegment FOREST_TOP = (TreeSegment) new TreeSegment(FabricBlockSettings.of(Material.WOOD), 15, 10).setAxe(true);

	public static TreeSegment GIANT_GLOWING_MUSHROOM_STEM = (TreeSegment) new TreeSegment(FabricBlockSettings.of(Material.WOOD), 15, 10).setAxe(true);
	public static TreeSegment GIANT_GLOWING_MUSHROOM_TOP = (TreeSegment) new TreeSegment(FabricBlockSettings.of(Material.WOOD).luminance(20), 10, 15).setAxe(true);
