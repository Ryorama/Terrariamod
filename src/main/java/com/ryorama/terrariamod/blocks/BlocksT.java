...
public class BlocksT {
	...
	public static Block GRASS_BLOCK = new Block(FabricBlockSettings.of(Material.SOIL).strength(4.0f, 4.0f));
	public static Block DIRT_BLOCK = new Block(FabricBlockSettings.of(Material.SOIL).strength(4.0f, 4.0f));
	public static Block STONE_BLOCK = new Block(FabricBlockSettings.of(Material.STONE).strength(4.0f, 4.0f));
