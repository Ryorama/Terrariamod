...
public class ItemsT {
    ...
    public static final RegistrySupplier<Item> ACORN = register("acorn", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> GEL = register("gel", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> LENS = register("lens", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> BLACK_LENS = register("black_lens", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> FALLEN_STAR = register("fallen_star", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> LIFE_CRYSTAL = register("life_crystal", () -> new LifeCrystal(new Item.Settings().maxCount(64)).setRarity(4));
    ...
    public static final RegistrySupplier<Item> COPPER_BAR = register("copper_bar", () ->  new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> IRON_BAR = register("iron_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> GOLD_BAR = register("gold_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> DEMONITE_BAR = register("demonite_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CRIMTANE_BAR = register("crimtane_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> HELLSTONE_BAR = register("hellstone_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(4));
    public static final RegistrySupplier<Item> TIN_BAR = register("tin_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> LEAD_BAR = register("lead_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> PLATINUM_BAR = register("platinum_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> TUNGSTEN_BAR = register("tungsten_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> SILVER_BAR = register("silver_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> METEORITE_BAR = register("meteorite_bar", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(4));
    ...
    public static final RegistrySupplier<Item> MUSHROOM = register("mushroom", () -> new Mushroom(new Item.Settings()));
    public static final RegistrySupplier<Item> VILE_MUSHROOM = register("vile_mushroom", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> VICIOUS_MUSHROOM = register("vicious_mushroom", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> GLOWING_MUSHROOM = register("glowing_mushroom", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> JUNGLE_SPORES = register("jungle_spores", () -> new ItemT(new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> BLINKROOT = register("blinkroot", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> DAYBLOOM = register("daybloom", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWEED = register("deathweed", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> FIREBLOSSOM = register("fireblossom", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> MOONGLOW = register("moonglow", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> SHIVERTHORN = register("shiverthorn", () -> new ItemT(new Item.Settings()));
    public static final RegistrySupplier<Item> WATERLEAF = register("waterleaf", () -> new ItemT(new Item.Settings()));
    ...
    public static final RegistrySupplier<Item> WOODEN_ARROW = register("wooden_arrow", () -> new WoodenArrow(new Item.Settings()).setMaxStack(64).setRarity(3));
    public static final RegistrySupplier<Item> FLAMING_ARROW = register("flaming_arrow", () -> new FlamingArrow(new Item.Settings()).setMaxStack(64).setRarity(3));
    ...
    public static final RegistrySupplier<Item> JUNGLE_GRASS_BLOCK = register("jungle_grass", () -> new BlockItemT(BlocksT.JUNGLE_GRASS.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> ASH_GRASS_BLOCK = register("ash_grass_block", () -> new BlockItemT(BlocksT.ASH_GRASS_BLOCK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> DIRT_BLOCK = register("dirt_block", () -> new BlockItemT(BlocksT.DIRT_BLOCK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> STONE_BLOCK = register("stone_block", () -> new BlockItemT(BlocksT.STONE_BLOCK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> BLUE_BRICK = register("blue_brick", () -> new BlockItemT(BlocksT.BLUE_BRICK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> GREEN_BRICK = register("green_brick", () -> new BlockItemT(BlocksT.GREEN_BRICK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> PURPLE_BRICK = register("purple_brick", () -> new BlockItemT(BlocksT.PURPLE_BRICK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> ASH_BLOCK = register("ash", () -> new BlockItemT(BlocksT.ASH.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> MUD_BLOCK = register("mud", () -> new BlockItemT(BlocksT.MUD.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> SAND_BLOCK = register("sand", () -> new BlockItemT(BlocksT.SAND.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> SANDSTONE_BLOCK = register("sandstone", () -> new BlockItemT(BlocksT.SANDSTONE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> SNOW_BLOCK = register("snow", () -> new BlockItemT(BlocksT.SNOW.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> ICE_BLOCK = register("ice", () -> new BlockItemT(BlocksT.ICE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> MARBLE = register("marble", () -> new BlockItemT(BlocksT.MARBLE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> GRANITE = register("granite", () -> new BlockItemT(BlocksT.GRANITE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> WOOD = register("wood", () -> new BlockItemT(BlocksT.WOOD.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CORRUPTED_WOOD = register("corrupted_wood", () -> new BlockItemT(BlocksT.CORRUPTED_WOOD.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CRIMSON_WOOD = register("crimson_wood", () -> new BlockItemT(BlocksT.CRIMSON_WOOD.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CACTUS = register("cactus", () -> new BlockItemT(BlocksT.CACTUS_BLOCK.get(), new Item.Settings().maxCount(64)).setRarity(2));

    public static final RegistrySupplier<Item> WOODEN_BEAM = register("wooden_beam", () -> new BlockItemT(BlocksT.WOODEN_BEAM.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> EBONSTONE = register("ebonstone", () -> new BlockItemT(BlocksT.EBONSTONE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CRIMSTONE = register("crimstone", () -> new BlockItemT(BlocksT.CRIMSTONE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> MUSHROOM_GRASS_BLOCK = register("mushroom_grass", () -> new BlockItemT(BlocksT.MUSHROOM_GRASS.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> HONEY_BLOCK = register("honey_block", () -> new BlockItemT(BlocksT.HONEY_BLOCK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CRISPY_HONEY_BLOCK = register("crispy_honey_block", () -> new BlockItemT(BlocksT.CRISPY_HONEY_BLOCK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> SUNPLATE_BLOCK = register("sunplate_block", () -> new BlockItemT(BlocksT.SUNPLATE_BLOCK.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CLOUD = register("cloud", () -> new BlockItemT(BlocksT.CLOUD.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> RAIN_CLOUD = register("rain_cloud", () -> new BlockItemT(BlocksT.RAIN_CLOUD.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> COPPER_ORE = register("copper_ore", () -> new BlockItemT(BlocksT.COPPER_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> IRON_ORE = register("iron_ore", () -> new BlockItemT(BlocksT.IRON_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> GOLD_ORE = register("gold_ore", () -> new BlockItemT(BlocksT.GOLD_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> DEMONITE_ORE = register("demonite_ore", () -> new BlockItemT(BlocksT.DEMONITE_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> CRIMTANE_ORE = register("crimtane_ore", () -> new BlockItemT(BlocksT.CRIMTANE_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> HELLSTONE_ORE = register("hellstone_ore", () -> new BlockItemT(BlocksT.HELLSTONE_ORE.get(), new Item.Settings().fireproof().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> TIN_ORE = register("tin_ore", () -> new BlockItemT(BlocksT.TIN_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> LEAD_ORE = register("lead_ore", () -> new BlockItemT(BlocksT.LEAD_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> PLATINUM_ORE = register("platinum_ore", () -> new BlockItemT(BlocksT.PLATINUM_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> SILVER_ORE = register("silver_ore", () -> new BlockItemT(BlocksT.SILVER_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> TUNGSTEN_ORE = register("tungsten_ore", () -> new BlockItemT(BlocksT.TUNGSTEN_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> METEORITE_ORE = register("meteorite_ore", () -> new BlockItemT(BlocksT.METEORITE_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> OBSIDIAN = register("obsidian", () -> new BlockItemT(BlocksT.OBSIDIAN.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> RUBY_ORE = register("ruby_ore", () -> new BlockItemT(BlocksT.RUBY_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> SAPPHIRE_ORE = register("sapphire_ore", () -> new BlockItemT(BlocksT.SAPPHIRE_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> EMERALD_ORE = register("emerald_ore", () -> new BlockItemT(BlocksT.EMERALD_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> DIAMOND_ORE = register("diamond_ore", () -> new BlockItemT(BlocksT.DIAMOND_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> TOPAZ_ORE = register("topaz_ore", () -> new BlockItemT(BlocksT.TOPAZ_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));
    public static final RegistrySupplier<Item> AMETHYST_ORE = register("amethyst_ore", () -> new BlockItemT(BlocksT.AMETHYST_ORE.get(), new Item.Settings().maxCount(64)).setRarity(2));

    public static final RegistrySupplier<Item> EMPTY_BOTTLE = register("empty_bottle", () -> new BlockItemT(BlocksT.EMPTY_BOTTLE.get(), new Item.Settings().maxCount(64)));
    public static final RegistrySupplier<Item> VINE = register("vine", () -> new BlockItemT(BlocksT.VINE.get(), new Item.Settings().maxCount(64)));

    public static final RegistrySupplier<Item> WOOD_CHEST = register("wood_chest", () -> new BlockItemT(BlocksT.WOOD_CHEST.get(), new Item.Settings().maxCount(64)));
    public static final RegistrySupplier<Item> GOLD_CHEST = register("gold_chest", () -> new BlockItemT(BlocksT.GOLD_CHEST.get(), new Item.Settings().maxCount(64)));
    public static final RegistrySupplier<Item> IVY_CHEST = register("ivy_chest", () -> new BlockItemT(BlocksT.IVY_CHEST.get(), new Item.Settings().maxCount(64)));
    public static final RegistrySupplier<Item> FROZEN_CHEST = register("frozen_chest", () -> new BlockItemT(BlocksT.FROZEN_CHEST.get(), new Item.Settings().maxCount(64)));
    public static final RegistrySupplier<Item> SANDSTONE_CHEST = register("sandstone_chest", () -> new BlockItemT(BlocksT.SANDSTONE_CHEST.get(), new Item.Settings().maxCount(64)));
